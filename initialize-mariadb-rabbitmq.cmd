...
SET MARIADB_COMMAND=docker run --detach --name !MARIADB_CONTAINER_NAME! -e MARIADB_ROOT_PASSWORD=123456 -e MARIADB_DATABASE=myspringeventdatabase -p 3306:3306 -v mariadb-volume:/var/lib/mysql !MARIADB_IMAGE!
