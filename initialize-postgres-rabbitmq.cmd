...
SET PG_COMMAND=docker run -d --name !PG_CONTAINER_NAME! -e "POSTGRESQL_USER=postgres" -e "POSTGRESQL_PASSWORD=123456" -e "POSTGRESQL_DATABASE=spring-base-event" -p 5432:5432 -v !PG_VOLUME_NAME!:/var/lib/postgresql/data !POSTGRESQL_IMAGE!
