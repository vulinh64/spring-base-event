...
PG_COMMAND="docker run -d --name ${PG_CONTAINER_NAME} -e \"POSTGRES_USER=postgres\" -e \"POSTGRES_PASSWORD=123456\" -e \"POSTGRES_DB=spring-base-event\" -p 5432:5432 -v ${PG_VOLUME_NAME}:/var/lib/postgresql ${POSTGRES_IMAGE}"
